                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="max-width:480px; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:40px;">
                            <h2 style="margin:0 0 8px; color:#1a1a1a; font-size:20px; font-weight:600;">Reset Your Password</h2>
                            <p style="margin:0 0 24px; color:#6b7280; font-size:14px; line-height:1.6;">
                                Hi {{ $userName }}, click the button below to reset your password.
                            </p>
                            <a href="{{ $resetUrl }}" style="display:block; background:#22c55e; color:#ffffff; text-decoration:none; font-weight:600; font-size:16px; padding:14px 32px; border-radius:12px; text-align:center; margin-bottom:24px;">
                                Reset Password
                            </a>
                            <p style="margin:0 0 8px; color:#9ca3af; font-size:12px; line-height:1.5;">
                                This link expires in 30 minutes. If you didn't request this, ignore this email.
                            </p>
                            <p style="margin:0; color:#9ca3af; font-size:11px; word-break:break-all;">
                                {{ $resetUrl }}
                            </p>
                        </td>
                    </tr>
