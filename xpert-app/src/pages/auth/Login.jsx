...
export default function Login() {
  ...
  return (
    <AuthLayout>
      ...
      <h2 className="text-2xl sm:text-3xl font-black text-[var(--color-text)] mb-2 tracking-tight">Welcome back</h2>
      <p className="text-sm sm:text-base text-[var(--color-text-secondary)] font-medium mb-8">Sign in to your account</p>
