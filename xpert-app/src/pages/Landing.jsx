                  ...
                  {workflowSteps.map((item, i) => (
                    ...
                    >
                      ...
                      >
                        ...
                        {activeStep !== i && (
                          <div className="absolute bottom-6 right-6 p-2 rounded-full bg-primary-500/10 text-primary-500 animate-bounce shadow-lg shadow-primary-500/5 sm:block hidden lg:block">
